...
namespace BrailleConverter
{
    public class RawPrinterHelper
    {
        ...
        public static bool SendStringToPrinter(string szPrinterName, string szString, string escapeSequence, bool doubleSpace)
        {
            //if (doubleSpace == true)
            //{
            //    szString = szString.Replace("\r\n", Environment.NewLine);
            //    szString = szString.Replace("\n\r", Environment.NewLine);
            //    szString = szString.Replace("\r", "");
            ...
            {
                char esc = (char)27;
                szString = esc + escapeSequence + szString;
            }

            IntPtr pBytes;
            // create a temp byte buffer
            byte[] encodedBytes = Encoding.ASCII.GetBytes(szString);
